...
#   new_array = holiday_hash[:spring].values.flatten
#   new_array << supply
...
puts add_supply_to_memorial_day(holiday_hash, "Fireworks")
...
def all_winter_holiday_supplies(holiday_hash)
  ...
  holiday_hash[:winter].map  {|holday, supplies| supplies}.flatten
